...
void mono_tracking(const std::shared_ptr<openvslam::config>& cfg,
                   ...
                   const unsigned int frame_skip, const bool no_sleep, const bool auto_term, const bool reverse_img_order,
...
int main(int argc, char* argv[]) {
    ...
    auto reverse_img_order = op.add<popl::Switch>("", "reverse", "process images in reverse order");
    ...
    if (cfg->camera_->setup_type_ == openvslam::camera::setup_type_t::Monocular) {
        mono_tracking(cfg, vocab_file_path->value(), img_dir_path->value(), mask_img_path->value(),
                      frame_skip->value(), no_sleep->is_set(), auto_term->is_set(), reverse_img_order->is_set(),
