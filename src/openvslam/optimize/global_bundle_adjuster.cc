...
void global_bundle_adjuster::optimize_all(const unsigned int lead_keyfrm_id_in_global_BA, bool* const force_stop_flag) const {
    // 1. Collect the dataset
    ...
    const auto insert_edge =
		[&optimizer](unsigned int id1, unsigned int id2, const g2o::Sim3& Sim3_21) {
			//auto edge = new optimize::internal::sim3::graph_opt_edge();
    		//auto edge = new g2o::BaseBinaryEdge<6, g2o::SE3Quat, openvslam::optimize::internal::se3::shot_vertex, openvslam::optimize::internal::se3::shot_vertex > ();
			...
			//edge->setVertex(0, dynamic_cast<g2o::BaseVertex<6, g2o::SE3Quat> *>(optimizer.vertex(id1)));
			//edge->setVertex(1, dynamic_cast<g2o::BaseVertex<6, g2o::SE3Quat> *>(optimizer.vertex(id2)));
    ...
    //g2o::Sim3 rp = Sim3s_cw.at(max_keyfrm_id) * Sim3s_cw.at(0).inverse();
    g2o::Sim3 rp;
